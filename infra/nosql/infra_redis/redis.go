...
func (client *Client) Echo(message any) (string, error) {
	return client.EchoCtx(context.Background(), message)
}

func (client *Client) EchoCtx(ctx context.Context, message any) (string, error) {
...
func (client *Client) SortInterfaces(key string, sort *redis.Sort) ([]any, error) {
	return client.SortInterfacesCtx(context.Background(), key, sort)
}

func (client *Client) SortInterfacesCtx(ctx context.Context, key string, sort *redis.Sort) ([]any, error) {
...
func (client *Client) GetSet(key string, value any) (string, error) {
	return client.GetSetCtx(context.Background(), key, value)
}

func (client *Client) GetSetCtx(ctx context.Context, key string, value any) (string, error) {
...
func (client *Client) MGet(keys ...string) ([]any, error) {
	return client.MGetCtx(context.Background(), keys...)
}

func (client *Client) MGetCtx(ctx context.Context, keys ...string) ([]any, error) {
	return client.conn.MGet(ctx, keys...).Result()
}

func (client *Client) MSet(values ...any) (string, error) {
	return client.MSetCtx(context.Background(), values)
}

func (client *Client) MSetCtx(ctx context.Context, values ...any) (string, error) {
	return client.conn.MSet(ctx, values).Result()
}

func (client *Client) MSetNX(values ...any) (bool, error) {
	return client.MSetNXCtx(context.Background(), values)
}

func (client *Client) MSetNXCtx(ctx context.Context, values ...any) (bool, error) {
	return client.conn.MSetNX(ctx, values).Result()
}

func (client *Client) Set(key string, value any, expiration time.Duration) (string, error) {
	return client.SetCtx(context.Background(), key, value, expiration)
}

func (client *Client) SetCtx(ctx context.Context, key string, value any, expiration time.Duration) (string, error) {
	return client.conn.Set(ctx, key, value, expiration).Result()
}

func (client *Client) SetArgs(key string, value any, a redis.SetArgs) (string, error) {
	return client.SetArgsCtx(context.Background(), key, value, a)
}

func (client *Client) SetArgsCtx(ctx context.Context, key string, value any, a redis.SetArgs) (string, error) {
	return client.conn.SetArgs(ctx, key, value, a).Result()
}

func (client *Client) SetEX(key string, value any, expiration time.Duration) (string, error) {
	return client.SetExCtx(context.Background(), key, value, expiration)
}

func (client *Client) SetExCtx(ctx context.Context, key string, value any, expiration time.Duration) (string, error) {
	return client.conn.SetEx(ctx, key, value, expiration).Result()
}

func (client *Client) SetNX(key string, value any, expiration time.Duration) (bool, error) {
	return client.SetNXCtx(context.Background(), key, value, expiration)
}

func (client *Client) SetNXCtx(ctx context.Context, key string, value any, expiration time.Duration) (bool, error) {
	return client.conn.SetNX(ctx, key, value, expiration).Result()
}

func (client *Client) SetXX(key string, value any, expiration time.Duration) (bool, error) {
	return client.SetXXCtx(context.Background(), key, value, expiration)
}

func (client *Client) SetXXCtx(ctx context.Context, key string, value any, expiration time.Duration) (bool, error) {
...
func (client *Client) BitField(key string, args ...any) ([]int64, error) {
	return client.BitFieldCtx(context.Background(), key, args)
}

func (client *Client) BitFieldCtx(ctx context.Context, key string, args ...any) ([]int64, error) {
...
func (client *Client) HMGet(key string, fields ...string) ([]any, error) {
	return client.HMGetCtx(context.Background(), key, fields...)
}

func (client *Client) HMGetCtx(ctx context.Context, key string, fields ...string) ([]any, error) {
	return client.conn.HMGet(ctx, key, fields...).Result()
}

func (client *Client) HSet(key string, values ...any) (int64, error) {
	return client.HSetCtx(context.Background(), key, values)
}

func (client *Client) HSetCtx(ctx context.Context, key string, values ...any) (int64, error) {
	return client.conn.HSet(ctx, key, values).Result()
}

func (client *Client) HMSet(key string, values ...any) (bool, error) {
	return client.HMSetCtx(context.Background(), key, values)
}

func (client *Client) HMSetCtx(ctx context.Context, key string, values ...any) (bool, error) {
	return client.conn.HMSet(ctx, key, values).Result()
}

func (client *Client) HSetNX(key, field string, value any) (bool, error) {
	return client.HSetNXCtx(context.Background(), key, field, value)
}

func (client *Client) HSetNXCtx(ctx context.Context, key, field string, value any) (bool, error) {
...
func (client *Client) LInsert(key, op string, pivot, value any) (int64, error) {
	return client.LInsertCtx(context.Background(), key, op, pivot, value)
}

func (client *Client) LInsertCtx(ctx context.Context, key, op string, pivot, value any) (int64, error) {
	return client.conn.LInsert(ctx, key, op, pivot, value).Result()
}

func (client *Client) LInsertBefore(key string, pivot, value any) (int64, error) {
	return client.LInsertBeforeCtx(context.Background(), key, pivot, value)
}

func (client *Client) LInsertBeforeCtx(ctx context.Context, key string, pivot, value any) (int64, error) {
	return client.conn.LInsertBefore(ctx, key, pivot, value).Result()
}

func (client *Client) LInsertAfter(key string, pivot, value any) (int64, error) {
	return client.LInsertAfterCtx(context.Background(), key, pivot, value)
}

func (client *Client) LInsertAfterCtx(ctx context.Context, key string, pivot, value any) (int64, error) {
...
func (client *Client) LPush(key string, values ...any) (int64, error) {
	return client.LPushCtx(context.Background(), key, values)
}

func (client *Client) LPushCtx(ctx context.Context, key string, values ...any) (int64, error) {
	return client.conn.LPush(ctx, key, values).Result()
}

func (client *Client) LPushX(key string, values ...any) (int64, error) {
	return client.LPushXCtx(context.Background(), key, values)
}

func (client *Client) LPushXCtx(ctx context.Context, key string, values ...any) (int64, error) {
...
func (client *Client) LRem(key string, count int64, value any) (int64, error) {
	return client.LRemCtx(context.Background(), key, count, value)
}

func (client *Client) LRemCtx(ctx context.Context, key string, count int64, value any) (int64, error) {
	return client.conn.LRem(ctx, key, count, value).Result()
}

func (client *Client) LSet(key string, index int64, value any) (string, error) {
	return client.LSetCtx(context.Background(), key, index, value)
}

func (client *Client) LSetCtx(ctx context.Context, key string, index int64, value any) (string, error) {
...
func (client *Client) RPush(key string, values ...any) (int64, error) {
	return client.RPushCtx(context.Background(), key, values)
}

func (client *Client) RPushCtx(ctx context.Context, key string, values ...any) (int64, error) {
	return client.conn.RPush(ctx, key, values).Result()
}

func (client *Client) RPushX(key string, values ...any) (int64, error) {
	return client.RPushXCtx(context.Background(), key, values)
}

func (client *Client) RPushXCtx(ctx context.Context, key string, values ...any) (int64, error) {
...
func (client *Client) SAdd(key string, members ...any) (int64, error) {
	return client.SAddCtx(context.Background(), key, members)
}

func (client *Client) SAddCtx(ctx context.Context, key string, members ...any) (int64, error) {
...
func (client *Client) SIsMember(key string, member any) (bool, error) {
	return client.SIsMemberCtx(context.Background(), key, member)
}

func (client *Client) SIsMemberCtx(ctx context.Context, key string, member any) (bool, error) {
	return client.conn.SIsMember(ctx, key, member).Result()
}

func (client *Client) SMIsMember(key string, members ...any) ([]bool, error) {
	return client.SMIsMemberCtx(context.Background(), key, members)
}

func (client *Client) SMIsMemberCtx(ctx context.Context, key string, members ...any) ([]bool, error) {
...
func (client *Client) SMove(source, destination string, member any) (bool, error) {
	return client.SMoveCtx(context.Background(), source, destination, member)
}

func (client *Client) SMoveCtx(ctx context.Context, source, destination string, member any) (bool, error) {
...
func (client *Client) SRem(key string, members ...any) (int64, error) {
	return client.SRemCtx(context.Background(), key, members)
}

func (client *Client) SRemCtx(ctx context.Context, key string, members ...any) (int64, error) {
...
func (client *Client) ZRem(key string, members ...any) (int64, error) {
	return client.ZRemCtx(context.Background(), key, members)
}

func (client *Client) ZRemCtx(ctx context.Context, key string, members ...any) (int64, error) {
...
func (client *Client) Eval(script string, keys []string, args ...any) (any, error) {
	return client.EvalCtx(context.Background(), script, keys, args)
}

func (client *Client) EvalCtx(ctx context.Context, script string, keys []string, args ...any) (any, error) {
	return client.conn.Eval(ctx, script, keys, args).Result()
}

func (client *Client) EvalSha(sha1 string, keys []string, args ...any) (any, error) {
	return client.EvalShaCtx(context.Background(), sha1, keys, args)
}

func (client *Client) EvalShaCtx(ctx context.Context, sha1 string, keys []string, args ...any) (any, error) {
