...
require (
	...
	github.com/luvx21/coding-go/coding-common v0.0.0-20241207140457-688f4e47a525
	github.com/luvx21/coding-go/infra/nosql/mongodb v0.0.0-20241207140457-688f4e47a525
...
require (
	...
	golang.org/x/net v0.33.0 // indirect; rect
