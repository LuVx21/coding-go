...
func NewPageIteratorSimple[ITEM any](
	...
	return NewPageIterator(initCursor, checkFirstCursor, dataAccessor, func_x.Identity[[]ITEM], endChecker)
}
...
func NewPageIterator[ITEM, ITEMS any](
	...
	return NewCursorIterator(initCursor, checkFirstCursor, dataAccessor, cursorExtractor, dataExtractor, endChecker)
}
...
func NewCursorIteratorSimple[ITEM, ID any](
	...
	return NewCursorIterator(initCursor, checkFirstCursor, dataAccessor, cursorExtractor,
