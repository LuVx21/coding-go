...
// ConcurrentMap 线程安全的map string:Anything, 内部分片
...
// ConcurrentMapShared 线程安全的map string to anything
...
// New 创建新的concurrent map.
func New[V any]() ConcurrentMap[string, V] {
    return create[string, V](fnv_x.Fnv32)
}

// NewStringer 创建新的concurrent map.
func NewStringer[K Stringer, V any]() ConcurrentMap[K, V] {
    return create[K, V](fnv_x.StrFnv32[K])
}

// NewWithCustomShardingFunction 创建新的concurrent map.
