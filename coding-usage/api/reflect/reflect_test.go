...
func Test_00(t *testing.T) {
    ...
    fmt_x.Println(
        []interface{}{"Type", "Type Kind", "Type Elem", "Type Elem Kind", "Value", "Value Kind", "Value Interface", "Value Elem", "Value Elem Kind", "Value Elem Interface"},
        aa(s1),
        aa(&s1),
        aa(s),
        aa(p1),
