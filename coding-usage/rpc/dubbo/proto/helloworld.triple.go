...
const (
	...
	GreeterSayHelloProcedure = "/proto.Greeter/SayHello"
)
...
// Greeter is a client for the proto.Greeter service.
...
func NewGreeter(cli *client.Client, opts ...client.ReferenceOption) (Greeter, error) {
	conn, err := cli.DialWithInfo("proto.Greeter", &Greeter_ClientInfo, opts...)
	if err != nil {
		return nil, err
	}
	return &GreeterImpl{
...
// GreeterHandler is an implementation of the proto.Greeter service.
