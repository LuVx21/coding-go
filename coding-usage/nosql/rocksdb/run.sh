...
LIB_PATH="$(brew config | grep HOMEBREW_PREFIX | cut -d' ' -f2)/Cellar"
...
export CGO_LDFLAGS="-L${rocksdb_home}/lib -lrocksdb -lstdc++ -lm -lz -lbz2 -L${snappy_home}/lib -L${lz4_home}/lib -L${zstd_home}/lib"
